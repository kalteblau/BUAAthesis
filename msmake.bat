...
::     在当前目录下编译论文，将执行lualatex命令，若无相应的cls/bst文件，将直接报错
::      - fast: 首次编译或完全清空时，不需要fast选项，将执行lualatex->bibtex->lualatex->lualatex命令
::              启用fast选项时仅执行lualatex，以改善编译速度
::   2、清理文件
...
if not exist gbt7714-buaa.bst goto bsterr
